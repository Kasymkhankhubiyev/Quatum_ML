...
class Model:
    ...
    def _layer_circuit(self, x, params, disp):
    ...
    def _circuit(self, x):
        ...
        def _single_circuit(x):
            ...
            q = self._layer(x, self.params_layer0, disp)
            print(f'layer 0: {q}')
            q = self._layer(q, self.params_layer1, disp)
            print(f'layer 1: {q}')
            # q = self._layer(q, self.params_layer2)
            # print(f'layer 0: {q}')

            return self._output_layer(q, self.params_layer2, disp)
