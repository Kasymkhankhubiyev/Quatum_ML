...
class Model:
    ...
    def _circuit(self, X, params):
        ...
        def _layer_circuit(x, params, delta):
            """
            54 parameters
        ...
        def _layer(x, params, delta) -> np.array:
            """
            8X8 - 64 // 4 = 16 блоков
        ...
        def _output_layer(x, params, delta):
        ...
        def _single_circuit(x, i):
            ...
            q = _layer(x, params, delta=0)
            q = _layer(q.flatten(), params, delta=54)
            output = _output_layer(q.flatten(), params, delta=108)
            return output
    ...
    def fit(self, lr: float, sq: float, steps: int, clf_task: str, trainX: list, trainY: list) -> None:
        ...
        if self.clf_task == 'binary':
            ...
            upload_params(file_name='Mnis/CNN/params.txt', input_name='CNN_params', data=self.params)
